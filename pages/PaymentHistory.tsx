      ...
      <main className="flex flex-col gap-4 px-4 pb-8">
        ...
        <div className="py-2">
          <label className="flex flex-col min-w-40 h-12 w-full">
            <div className="flex w-full flex-1 items-stretch rounded-lg h-full bg-slate-200/50 dark:bg-slate-800">
              ...
              <input
                className="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg focus:outline-0 bg-transparent h-full placeholder:text-slate-400 px-4 pl-2 text-base"
        ...
        <div className="flex flex-col gap-3">
          {filteredTransactions.map((t) => (
            <div
              key={t.id}
              className="flex flex-col rounded-xl bg-card-light dark:bg-card-dark p-4 shadow-sm"
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <p className="text-base font-semibold leading-normal shrink-0">
                  ₦{t.amount.toFixed(2)}
                </p>
              </div>
