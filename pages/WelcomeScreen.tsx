      ...
      <div className="flex flex-col h-full min-h-screen justify-between bg-white dark:bg-background-dark">
        <div className="flex flex-col items-center pt-16 animate-fade-in-up">
          ...
          <div className="w-full px-6 py-8">
            <div className="w-full h-[360px] sm:h-[400px] md:h-[460px] bg-linear-to-br from-accent/20 to-primary/20 rounded-3xl flex items-center justify-center overflow-hidden relative">
              ...
              <span className="material-symbols-outlined text-[280px] sm:text-[300px] text-accent z-10 relative">
                potted_plant
              </span>
            </div>
          </div>
