...
export const SubmitTransferButton: React.FC<SubmitTransferButtonProps> = ({
  ...
  <div className="mt-auto pt-4">
    <button
      ...
      className="w-full h-16 text-white rounded-2xl font-black text-base uppercase tracking-widest shadow-xl disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center transition-all active:scale-95 bg-success shadow-success/20"
    >
      {isProcessing ? (
